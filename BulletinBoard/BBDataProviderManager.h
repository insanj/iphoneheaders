...
@class BBLocalDataProviderStore, NSMutableDictionary, NSString, BBLocalDataProviderStore, BBRemoteDataProviderConnectionResolver;// <BBDataProviderManagerDelegate> NSObject<OS_dispatch_queue>;
